...
//		int range = [-2^31, 2^31 - 1];
	...
	/**
	 * According to the hash number of the key, assign a index position in array for the key 
	 * */
	...
	// traverse the whole array, and traverse each of the linked list in the array to check for the value. O(n),
	...
	/**
	 * create a new double sized array, for each node in the old array, put to the new larger array(
	 * add to the head of the linked list). if the key exists, remove the <key, value> from the HashMap,
	 * return the value, if the key not exists, return null
	 * */
