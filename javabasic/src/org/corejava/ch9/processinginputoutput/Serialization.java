...
/**
 * Turning an object into a bunch of bytes that can be stored on disk, and reconstitude the object from those bytes
 * */
public class Serialization {
	...
	public static void main(String args[]) {
		...
		//Path filePath = Paths.get("/Users/serenapang/Development/JavaBasics/javabasic/src/org/corejava/ch9/processinginputoutput/employee.txt");
