...
public class StreamsLambda {
	public static void main(String[] args) {
		Stream<String> words = Stream.of("how much could a wood chuck chuk".split(" "))
				.filter(w -> w.length() > 4);
		...
		words = Stream.of("how much wood could a wood chuck chuck".split(" "))
				...
				show("Filtering with parameter type", words);
		
				Stream<String> distinctWords = Stream.of("how much wood could a wood chuck chuck".split(" "))
						.distinct();
				Stream<String> sortedWords = distinctWords.sorted((s,t) -> s.length() - t.length()); //s is the first word, t is the second word
				show("Sorting with a lambda expression with two parameters", sortedWords);
		
				distinctWords = Stream.of("how much wood could a wood chuck chuck".split(" "))
						.distinct();
	 ...
	 * */
	private static <T> void show(String caption, Stream<T> stream) {
