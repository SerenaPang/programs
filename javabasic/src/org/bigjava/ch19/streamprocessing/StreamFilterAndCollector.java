...
public class StreamFilterAndCollector {
	public static void main(String[] args) {
		...
		words = Stream.of("how much wood could a wood chunk chuk".split(" "));
		...
		distinctWords = Stream.of("how much wood could a wood chunk chuk".split(" ")).distinct();
		Stream<String> sortedWords = distinctWords.sorted();
		show("Sortedwords", sortedWords);
	}

	/**
	 * Displays the first ten values in a stream, followed by... if there are additional values
