...
/**
 * This frame contains a panel that displays buttons for a calculator and a panel with a text fields to specify the result of calculation.
 * The operator buttons don't do anything.
 * */
public class CalculatorFrame extends JFrame{
	...
	class DigitButtonListener implements ActionListener
	{
		...
		/**
		 * constructs a listener whose actionPerformed method adds a digit to the display
	 ...
	 * @return the button of the calculator
	 * */
	private JButton makeDigitButton(String digit) {
